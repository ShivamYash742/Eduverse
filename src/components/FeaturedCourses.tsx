  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (leftButton && rightButton) {
        ...
        rightButton.style.opacity = scrollLeft < maxScrollLeft - 5 ? '1' : '0.5';
      }
    };
    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            <h2 className="text-sm text-neon-purple font-semibold uppercase tracking-wider mb-2">Featured Courses</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-white">Expand Your Knowledge</h3>
          </div>
