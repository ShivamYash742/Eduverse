    ...
    <section className="py-20 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-sm text-neon-blue font-semibold uppercase tracking-wider mb-2">Interactive Quizzes</h2>
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">Challenge Yourself</h3>
          <p className="text-muted-foreground">
            Test your knowledge with our gamified quizzes. Earn points, collect badges, and climb the leaderboards as you learn.
          </p>
        </div>
            ...
            >
              <div className={`bg-gradient-to-b ${category.color} p-6`}>
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="text-white font-semibold">{category.count} Quizzes</span>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-white/5 flex justify-between items-center">
                  <button className="text-sm font-medium text-white hover:text-neon-blue transition-colors">
                    Start Quizzing
                  </button>
        ...
        <div className="glass-panel rounded-xl p-6 md:p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              <h4 className="text-2xl font-bold text-white mb-4">Gamified Learning Experience</h4>
              <p className="text-muted-foreground mb-6">
                Our quizzes are designed to make learning fun and engaging. Earn points, unlock badges, and compete with friends.
              </p>
              
              <ul className="space-y-4">
                {[
                  { icon: <Award className="h-5 w-5 text-neon-purple" />, text: "Earn badges for completing quiz series" },
                  { icon: <Target className="h-5 w-5 text-neon-blue" />, text: "Track your progress with detailed analytics" },
                  { icon: <TrendingUp className="h-5 w-5 text-neon-pink" />, text: "Compete on global and friend leaderboards" }
                ].map((item, index) => (
              ...
              <button className="mt-8 px-6 py-3 rounded-lg bg-neon-blue hover:bg-neon-blue/90 transition-all text-white font-medium">
                Explore Quizzes
              </button>
            </div>
            ...
            <div className="flex items-center justify-center">
              <div className="relative w-full max-w-md aspect-square">
                ...
                <div className="absolute top-0 left-1/4 w-32 h-32 glass-effect rounded-xl flex items-center justify-center animate-float" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="absolute bottom-0 right-1/4 w-32 h-32 glass-effect rounded-xl flex items-center justify-center animate-float" style={{ animationDelay: '0.5s' }}>
                ...
                <div className="absolute top-1/3 right-0 w-32 h-32 glass-effect rounded-xl flex items-center justify-center animate-float" style={{ animationDelay: '0.8s' }}>
