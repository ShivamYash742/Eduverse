  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <span className="text-white text-sm font-medium mr-1">{rating.toFixed(1)}</span>
            <span className="text-muted-foreground text-xs">({studentsCount})</span>
          </div>
      ...
      <div className="p-4 border-t border-white/5 flex items-center justify-between">
        <button className="text-white text-sm font-medium hover:text-neon-purple transition-colors">
          View Course
        </button>
