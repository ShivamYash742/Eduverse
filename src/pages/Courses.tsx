...
const allCourses = [
  ...
  },
  {
    ...
    category: "Physics",
    image: "https://images.unsplash.com/photo-1639322537504-6427a16b0a28?q=80&w=2232&auto=format&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1551033406-611cf9a28f67?q=80&w=2187&auto=format&fit=crop",
  ...
  },
  {
    ...
    category: "Technology",
    image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=2124&auto=format&fit=crop",
...
const categories = [
  "All Categories", "Technology", "Programming", "Data Science", "Design", 
  "Business", "Marketing", "Finance", "Cloud", "Security", "Physics", "Gaming"
];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              <h2 className="text-xl font-semibold text-white mb-1">
                {filteredCourses.length} Courses {selectedCategory !== 'All Categories' ? `in ${selectedCategory}` : ''}
              </h2>
              {searchQuery && (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            <div className="text-muted-foreground">
              Showing <span className="text-white font-medium">{filteredCourses.length}</span> of <span className="text-white font-medium">{allCourses.length}</span> courses
            </div>
