...
import { Users, MessageSquare, ArrowUp, Filter, Search, Heart, MessageCircle, Share2, Award } from 'lucide-react';
...
const communityPosts = [
  {
    ...
    role: "Data Scientist",
    date: "2 hours ago",
    content: "Just completed the Advanced Machine Learning course! The final project on neural networks was challenging but incredibly rewarding. Has anyone else taken this course?",
    likes: 24,
    comments: 8,
  ...
  },
  {
    ...
    date: "5 hours ago",
    content: "Looking for study partners for the upcoming Cloud Computing certification exam. I'm planning to take it next month and would love to form a study group!",
    likes: 18,
    comments: 15,
  ...
  },
  {
    ...
    role: "UX Designer",
    date: "Yesterday",
    content: "I just published my article on 'Design Systems for Educational Platforms' based on learnings from the UX/UI Fundamentals course here. Check it out and let me know your thoughts!",
    likes: 47,
    comments: 12,
  ...
  },
  {
    ...
    date: "2 days ago",
    content: "The Quantum Computing quiz was mind-blowing! I scored 85% but got stuck on the questions about quantum entanglement. Any quantum physics experts here who can explain the concept more intuitively?",
    likes: 32,
    comments: 21,
...
const activeMembers = [
  { name: "Lisa Wang", avatar: "https://i.pravatar.cc/150?img=10", role: "AI Researcher", points: 1250 },
  { name: "Jamal Carter", avatar: "https://i.pravatar.cc/150?img=2", role: "Frontend Developer", points: 980 },
  { name: "Elena Morozova", avatar: "https://i.pravatar.cc/150?img=9", role: "Data Engineer", points: 865 },
  { name: "Raj Patel", avatar: "https://i.pravatar.cc/150?img=7", role: "Cybersecurity Expert", points: 750 },
  { name: "Sophia Chen", avatar: "https://i.pravatar.cc/150?img=4", role: "Mobile Developer", points: 620 }
];
...
const upcomingEvents = [
  ...
  { 
    ...
    date: "June 22, 2023", 
    participants: 85,
    image: "https://images.unsplash.com/photo-1593720219276-0b1eacd0aef4?q=80&w=2061&auto=format&fit=crop"
  },
  { 
    ...
    <div className="glass-panel rounded-xl p-6 mb-6">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-white/5">
        <div className="flex items-center gap-4">
          <button 
            className={`flex items-center gap-1.5 ${liked ? 'text-red-500' : 'text-muted-foreground'} hover:text-white transition-colors`}
            onClick={handleLike}
          >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-12 text-center animate-on-scroll">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Connect with fellow learners, share your progress, ask questions, and participate in discussions.
            </p>
            
            <div className="flex justify-center gap-4">
              <button className="px-6 py-3 bg-neon-purple rounded-lg text-white font-medium flex items-center gap-2 hover:bg-neon-purple/90 transition-colors neon-glow neon-glow-purple">
                <Users size={18} />
                Join Community
              </button>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-6 border-b border-white/10 animate-on-scroll">
                <div className="flex overflow-x-auto">
                  {['trending', 'latest', 'popular', 'following', 'my posts'].map((tab) => (
                    <button
                      key={tab}
            ...
            <div className="space-y-6">
              ...
              <div className="glass-panel rounded-xl p-6 animate-on-scroll">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-accent/40 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-white mb-1">15.8K</div>
                    <div className="text-muted-foreground text-sm">Members</div>
                  </div>
                  <div className="bg-accent/40 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-neon-purple mb-1">4.2K</div>
                    <div className="text-muted-foreground text-sm">Online</div>
                  </div>
                  <div className="bg-accent/40 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-neon-blue mb-1">28.5K</div>
                    <div className="text-muted-foreground text-sm">Posts</div>
                  </div>
                  <div className="bg-accent/40 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-neon-pink mb-1">125K</div>
                  ...
                  {activeMembers.map((member, index) => (
                    <div key={index} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-white text-sm">{member.points}</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-4">
                  {upcomingEvents.map((event, index) => (
                    <div key={index} className="group cursor-pointer">
                      ...
                      <h4 className="text-white text-sm font-medium group-hover:text-neon-purple transition-colors">{event.title}</h4>
                      <p className="text-muted-foreground text-xs">{event.participants} participants</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="glass-panel rounded-xl p-6 animate-on-scroll">
                ...
                <div className="flex flex-wrap gap-2">
                  {["AI", "Machine Learning", "Web Development", "Python", "React", "Data Science", "UX Design", "Cloud Computing", "Cybersecurity", "JavaScript", "Blockchain"].map((tag, index) => (
                    <span 
                      key={index} 
